...
export class ClientListComponent implements OnInit {
  ...
  constructor(private ClientService: ClientService, private toastr: ToastrService,
     ...
     subscriptionClientID: Subscription | undefined ;
  ...
  getClientcontact() {
    ...
    //     data => {
          ...
          if (result.data) {
            ...
            this.getClientIDContactIFOtable();
          }
        },
...
console.log(oContact)
  ...
  getClientIDContactIFOtable() {
    this.ClientService._getclientID
    .pipe(take(1))  //this will limit the observable to only one value
    .subscribe((data) => {
      console.log('emit tghe client data======================',data)
if(data != 'null' && data != ''){
  this.selectContact(data);
    ...
    // this.subscriptionClientID = this.ClientService._getclientID.subscribe((data) => {
    //  console.log('emit tghe client data======================',data)
    // //  if(data != null){
    //   this.selectContact(data);
    //   // 
  ...
  let   s = [];
    ...
    this.subscriptionClientList?.unsubscribe();
     this.subscriptionClientID?.unsubscribe();
